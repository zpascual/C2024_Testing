...
public class HeadingControlPlanner {
    ...
    private final ProfileFollower profile_follower_ = new ProfileFollower(Constants.SwerveHeadingController.kHeadingControllerKp, Constants.SwerveHeadingController.kHeadingControllerKi, Constants.SwerveHeadingController.kHeadingControllerKd, Constants.SwerveHeadingController.kHeadingControllerKffv, Constants.SwerveHeadingController.kHeadingControllerKffa, Constants.SwerveHeadingController.kHeadingControllerKs);
    ...
    public ChassisSpeeds update(double timestamp, ChassisSpeeds desired, Twist2d current_vel, Rotation2d gyro) {
        ...
        if (yaw_goal_.isPresent() && has_translation_command) {
            ...
            profile_follower_.setGoalAndConstraints(yaw_goal_.get(), Constants.SwerveMotionProfile.kHeading);
