package com.team1678.lib.motion;
...
public class MotionProfileGenerator {
    ...
    protected static MotionProfile generateProfileImpl(MotionProfileConstraints constraints,
        ...
        if (min_abs_vel_at_goal_sqr > 0.0
            ...
            // do.
            if (goal_state.completion_behavior() == IMotionProfileGoal.CompletionBehavior.VIOLATE_MAX_ABS_VEL) {
                // Adjust the goal velocity.
                goal_vel = min_abs_vel_at_goal;
            } else if (goal_state.completion_behavior() == IMotionProfileGoal.CompletionBehavior.VIOLATE_MAX_ACCEL) {
